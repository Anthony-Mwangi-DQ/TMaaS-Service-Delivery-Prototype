...
import { FileText, Download, Eye, History, MessageSquare, ChevronDown, ChevronRight, Clock, User, FolderOpen } from "lucide-react";
...
const documents: Document[] = [
  ...
  // Milestone 1 Deliverables
  {
    ...
    versions: [
      ...
      { version: "v1.0", uploadedDate: "Jan 28, 2024", uploadedBy: "DQ Lead", comment: "Initial assessment" },
    ],
  },
  ...
  },
  {
    ...
    status: "final",
    versions: [
      { version: "v1.0", uploadedDate: "Feb 15, 2024", uploadedBy: "DQ Lead", comment: "Final approved version" },
    ],
  },
  // Client Inputs
  {
...
const categoryConfig = {
  Deliverables: { color: "bg-primary/10 text-primary border-primary/20", icon: "📦" },
  Inputs: { color: "bg-info/10 text-info border-info/20", icon: "📥" },
};

const milestoneConfig = {
  "Kickoff": { color: "bg-success/10 text-success border-success/20" },
  "Milestone 1": { color: "bg-info/10 text-info border-info/20" },
  "Milestone 2": { color: "bg-primary/10 text-primary border-primary/20" },
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Grouped by milestone</p>
            </div>
          </div>
          {/* No upload button for Deliverables - Client cannot upload */}
        </div>
            ...
            return (
              <div key={milestone}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-muted-foreground">{docs.length} deliverable{docs.length > 1 ? 's' : ''}</span>
                </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{inputDocs.length} files</p>
              </div>
            </div>
